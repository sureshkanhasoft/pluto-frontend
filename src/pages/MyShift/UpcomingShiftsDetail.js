...
const UpcomingShiftsDetail = ({ match }) => {
        ...
        <>
            ...
            <section className="pt-16 pb-32">
                <Container maxWidth="lg">
                    <Link to="/my-shifts/upcoming" className="back-button"><KeyboardArrowLeftIcon /> Back to all shifts </Link>
...
export default UpcomingShiftsDetail;